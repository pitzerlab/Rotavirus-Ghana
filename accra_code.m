...
load('accra_demographic_parameters.mat');
load('accra_model_parameters.mat');
...
pars=[37.861;0.8063;0.077;7.203;0.132;1.037;0.107;9.54e-06;0.989;24.102]; %mean
...
if avacc(3)>0
v3(:,avacc(3))=0*[zeros(t0+tvacc+2,1); (vcov(3:end,2)-0.0)];     %Vaccine coverage by month with 3 doses
end
...
A_postvacc=A(64:183,1)'*sum(H(64:183,1:au5),2)/sum(sum(H(64:183,1:au5)));
...
%%- -  output file
save('accra_results.mat','cases_U5Y', 'cases_U1Y','cases_1Y', 'cases_2_4Y', 'age_dist');
